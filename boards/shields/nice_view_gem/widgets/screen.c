...
#include "wpm_pet.h"
static struct zmk_widget_wpm_pet wpm_pet_widget;
#endif
...
int zmk_widget_screen_init(struct zmk_widget_screen *widget, lv_obj_t *parent) {
    ...
    lv_obj_align(zmk_widget_wpm_pet_obj(&wpm_pet_widget), LV_ALIGN_TOP_RIGHT, -50, 16);
#endif
